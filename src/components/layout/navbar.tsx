...
import { Sword, Users, User, LogOut, Home, ShoppingBag, Star, Sparkles, Trees } from "lucide-react";
...
export function Navbar() {
  ...
  const links = [
    { href: "/village",  label: "任务",   icon: Sword },
  ...
  return (
    <nav className="sticky top-0 z-40 border-b border-amber-800/20 bg-stone-950/90 backdrop-blur">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-4 h-14">
        <Link href="/planet" className="flex items-center gap-2 shrink-0">
